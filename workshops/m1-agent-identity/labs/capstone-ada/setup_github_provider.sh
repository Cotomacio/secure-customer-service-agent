...
echo
echo "⚠️  NEXT STEP REQUIRED: 3LO needs a one-time user consent."
echo "   Run:  python consent_github.py"
echo "   It opens a localhost callback, prints a GitHub auth URL for you"
echo "   to authorize, then stores the credential in Auth Manager."
echo
echo "📌 IMPORTANT: in your GitHub OAuth App settings"
echo "   (https://github.com/settings/developers), set the Authorization"
echo "   callback URL to: http://localhost:8080/callback"
